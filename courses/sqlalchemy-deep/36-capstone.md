...
Production-ready **data layer** для catalog + orders — **5–7 часов**. Расширение [`deploy/sqlalchemy/stack`](../../deploy/sqlalchemy/stack).
...
Поздравляем — курс **SQLAlchemy Deep** завершён.
