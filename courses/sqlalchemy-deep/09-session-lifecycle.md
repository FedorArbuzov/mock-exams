...
**Session** — ORM workspace: identity map, unit of work, transaction boundary. Путаница flush/commit — #1 источник багов.
...
Стенд: [`SyncSessionLocal`](../../deploy/sqlalchemy/stack/shop/db.py).
...
Далее: [10-lab-sync-session](10-lab-sync-session.md).
