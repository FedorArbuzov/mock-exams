# 20. Лаба: async setup + queries

## Цель

CRUD через AsyncSession; compare syntax with sync.
...
Далее: [21-async-patterns](21-async-patterns.md).
