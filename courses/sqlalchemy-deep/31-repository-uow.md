...
Views/services с raw `select()` everywhere — duplication. **Repository** encapsulates persistence; **Unit of Work** = one Session per request.
...
Далее: [32-lab-repository](32-lab-repository.md).
