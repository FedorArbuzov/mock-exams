...
FK column alone не даёт `product.category.name` — нужен **`relationship()`**. Настройка lazy loading определяет **когда** летит SQL.
...
Далее: [14-lab-fk-relationship](14-lab-fk-relationship.md).
