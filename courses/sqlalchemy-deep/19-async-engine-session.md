...
FastAPI endpoints — `async def`. Blocking sync Session **замораживает event loop**. **AsyncSession** + **asyncpg** — standard stack.

[`fastapi/13`](../fastapi/13-sqlalchemy-async.md) — API integration; здесь — mechanics.
...
Стенд: [`shop/db.py`](../../deploy/sqlalchemy/stack/shop/db.py).
...
Далее: [20-lab-async-crud](20-lab-async-crud.md).
