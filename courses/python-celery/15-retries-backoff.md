...
SMTP down, payment gateway 503 — **transient errors**. Celery retry с backoff лучше чем immediate flood.
...
Стенд `send_welcome_email` — random failure + `2 ** retries`.
...
Далее: [16-lab-retries](16-lab-retries.md).
