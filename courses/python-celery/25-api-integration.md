...
Celery живёт **рядом** с web app — shared code, separate processes. API enqueue; workers import same task modules.

## Что вы узнаете

- FastAPI trigger pattern (стенд).
- Django + celery integration sketch.
...
Далее: [26-lab-api-trigger](26-lab-api-trigger.md).
