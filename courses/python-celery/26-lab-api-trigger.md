# 26. Лаба: trigger from API end-to-end

## Цель

Полный flow: **POST order → task_id → poll → GET order status**; simulate broker outage.

---

## Шаг 1. Happy path script
...
## Шаг 5. Latency measure

Time from POST to SUCCESS — orientir 1–2s for `process_order` (1s sleep in task).
...
Далее: [27-flower-monitoring](27-flower-monitoring.md).
