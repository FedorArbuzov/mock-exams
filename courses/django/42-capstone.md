...
Построить **production-ready** catalog service на Django 5 + DRF — **6–8 часов**. Можно форкнуть [`deploy/django/stack/web`](../../deploy/django/stack/web) или расширить in-place.
...
Поздравляем — курс **Django** завершён.
