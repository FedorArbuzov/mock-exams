# 41. Interview Q&A: Django and DRF (top 40)

## Architecture

**1. MTV vs MVC?** Model–Template–View; Template ≈ View, View ≈ Controller.

**2. Django vs FastAPI?** Django — platform (ORM, admin, auth); FastAPI — typed ASGI API. DRF for REST in Django.

**3. WSGI vs ASGI?** Sync workers vs async protocol; Django 5 async views partial.

**4. Why INSTALLED_APPS?** Registry models, commands, static, admin.

---

## ORM

**5. QuerySet lazy?** SQL at evaluation.
...
Practice: [42-capstone](42-capstone.md). Cheatsheet: [interview-cheatsheet](interview-cheatsheet.md).

Next: [42-capstone](42-capstone.md).
