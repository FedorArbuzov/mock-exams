# 23. Sync vs async: when to use which

## Intro

"Let's rewrite everything on async" — not always a win. SQLAlchemy sync + threads vs async + event loop — tradeoffs.
...
Next: [24-lab-dual-engine](24-lab-dual-engine.md).
