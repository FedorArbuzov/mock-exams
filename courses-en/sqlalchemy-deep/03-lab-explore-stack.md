# 03. Lab: explore the stack + psql

## Scenario

First day — bring up Postgres **5433**, migrate, seed, confirm SQLAlchemy sees the schema.
...
Next: [04-metadata-core-crud](04-metadata-core-crud.md).
