...
A Product has many **Tags**; a Tag applies to many **Products**. Junction table **`product_tags`** — Core `Table`, not ORM class (usually).
...
Reference: [`models.py`](../../deploy/sqlalchemy/stack/shop/models.py).
...
Next: [18-lab-tags-m2m](18-lab-tags-m2m.md).
