# 05. Lab: Core CRUD without ORM

## Goal

Insert, update, delete a row via **Core only** — understand the SQL that the ORM generates.

---

## Step 1. Define Table (scratch script)
...
Next: [06-core-select-expressions](06-core-select-expressions.md).
