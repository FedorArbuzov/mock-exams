...
Alembic, bulk scripts, legacy DB introspection — you often need a **Core Table**, not an ORM class. MetaData is the registry of all tables.
...
ORM `Base.metadata` — the same object used by Alembic — [`shop/models.py`](../../deploy/sqlalchemy/stack/shop/models.py).
...
Next: [05-lab-core-crud](05-lab-core-crud.md).
