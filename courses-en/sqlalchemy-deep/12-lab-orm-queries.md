# 12. Lab: filters, order_by, pagination

## Goal

Write query helpers: active products by category, price range, paginated list.

---

## Step 1. By category slug
...
Next: [13-relationships-basics](13-relationships-basics.md).
