...
Add `tests/` for the shop package: unit tests for tasks + a mocked API.
...
- [ ] pytest green locally or in a container
- [ ] ≥4 test functions
- [ ] idempotent + fail cases covered

Next: [33-troubleshooting](33-troubleshooting.md).
