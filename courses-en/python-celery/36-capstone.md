...
Build a **production-style** order pipeline on Celery — **4–6 hours**. Fork [`deploy/celery`](../../deploy/celery/stack) or extend it in place.
...
Congratulations — you've completed the **Python Celery** course.
