...
import {Scene2Modules} from "./scenes/Scene2Modules";
import {Scene3RootPath} from "./scenes/Scene3RootPath";
import {Scene4OldTutorial} from "./scenes/Scene4OldTutorial";
import {Scene5ModernRule} from "./scenes/Scene5ModernRule";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  modules: Scene2Modules,
  rootpath: Scene3RootPath,
  oldtutorial: Scene4OldTutorial,
  modernrule: Scene5ModernRule,
