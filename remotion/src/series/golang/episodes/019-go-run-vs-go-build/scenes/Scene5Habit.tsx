...
import {CheckCircle2, GitCommitHorizontal, Play} from "lucide-react";
...
const STEPS = [
  ...
  {label: "build passes", Icon: CheckCircle2, color: COLORS.cyan},
  {label: "commit", Icon: GitCommitHorizontal, color: COLORS.white},
];
              ...
              return (
                <React.Fragment key={step.label}>
                  ...
                  >
                    ...
                    >
                      <Icon size={64} color={step.color} strokeWidth={1.6} />
                    </div>
