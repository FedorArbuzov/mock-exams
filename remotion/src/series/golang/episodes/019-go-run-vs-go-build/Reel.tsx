...
import {Scene2WhenToUse} from "./scenes/Scene2WhenToUse";
import {Scene3Production} from "./scenes/Scene3Production";
import {Scene4Mistake} from "./scenes/Scene4Mistake";
...
const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  ...
  whentouse: Scene2WhenToUse,
  production: Scene3Production,
  mistake: Scene4Mistake,
  habit: Scene5Habit,
