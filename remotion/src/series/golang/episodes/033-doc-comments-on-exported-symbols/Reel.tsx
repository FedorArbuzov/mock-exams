...
import {Scene2CommentAbove} from "./scenes/Scene2CommentAbove";
import {Scene3ToolingRenders} from "./scenes/Scene3ToolingRenders";
import {Scene4PrReview} from "./scenes/Scene4PrReview";
import {Scene5DocHabit} from "./scenes/Scene5DocHabit";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  commentabove: Scene2CommentAbove,
  toolingrenders: Scene3ToolingRenders,
  prreview: Scene4PrReview,
  dochabit: Scene5DocHabit,
