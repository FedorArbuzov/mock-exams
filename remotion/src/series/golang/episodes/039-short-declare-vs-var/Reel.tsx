...
import {Scene2Usage} from "./scenes/Scene2Usage";
import {Scene3Scoping} from "./scenes/Scene3Scoping";
import {Scene4PackageLevel} from "./scenes/Scene4PackageLevel";
import {Scene5Style} from "./scenes/Scene5Style";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  usage: Scene2Usage,
  scoping: Scene3Scoping,
  packagelevel: Scene4PackageLevel,
  style: Scene5Style,
