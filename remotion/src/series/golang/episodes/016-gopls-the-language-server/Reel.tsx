...
import {Scene3WhenBroken} from "./scenes/Scene3WhenBroken";
import {Scene4VersionAlign} from "./scenes/Scene4VersionAlign";
import {Scene5DebugHabit} from "./scenes/Scene5DebugHabit";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  whatisit: Scene2WhatIsIt,
  whenbroken: Scene3WhenBroken,
  versionalign: Scene4VersionAlign,
  debughabit: Scene5DebugHabit,
