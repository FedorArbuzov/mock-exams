...
import {Scene2Whenuse} from "./scenes/Scene2Whenuse";
import {Scene3Avoid} from "./scenes/Scene3Avoid";
import {Scene4Naked} from "./scenes/Scene4Naked";
import {Scene5Guideline} from "./scenes/Scene5Guideline";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  whenuse: Scene2Whenuse,
  avoid: Scene3Avoid,
  naked: Scene4Naked,
  guideline: Scene5Guideline,
