...
import {Scene2Enforcement} from "./scenes/Scene2Enforcement";
import {Scene3StrongerThanConvention} from "./scenes/Scene3StrongerThanConvention";
import {Scene4Layout} from "./scenes/Scene4Layout";
...
const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  ...
  enforcement: Scene2Enforcement,
  strongerthanconvention: Scene3StrongerThanConvention,
  layout: Scene4Layout,
  usecase: Scene5UseCase,
