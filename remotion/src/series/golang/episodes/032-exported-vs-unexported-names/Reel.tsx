...
import {Scene4NotStyle} from "./scenes/Scene4NotStyle";
import {Scene5ApiRule} from "./scenes/Scene5ApiRule";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  rule: Scene2Rule,
  example: Scene3Example,
  notstyle: Scene4NotStyle,
  apirule: Scene5ApiRule,
