...
import {FileCode2, Folder, FolderLock} from "lucide-react";
...
const ITEMS = [
  {label: "cmd", sub: "binaries", Icon: Folder},
  {label: "internal", sub: "private libs", Icon: FolderLock},
  {label: "go.mod", sub: "at root", Icon: FileCode2},
];

export const Scene5Shape: React.FC<Props> = ({text, durationInFrames}) => {
