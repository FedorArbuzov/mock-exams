...
import {Scene2Uniqueness} from "./scenes/Scene2Uniqueness";
import {Scene3NotFetchable} from "./scenes/Scene3NotFetchable";
import {Scene4RenameWarning} from "./scenes/Scene4RenameWarning";
...
const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  ...
  uniqueness: Scene2Uniqueness,
  notfetchable: Scene3NotFetchable,
  renamewarning: Scene4RenameWarning,
  rule: Scene5Rule,
