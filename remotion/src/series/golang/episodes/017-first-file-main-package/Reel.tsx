...
import {Scene2EntryPoint} from "./scenes/Scene2EntryPoint";
import {Scene3OtherPackages} from "./scenes/Scene3OtherPackages";
import {Scene4ErrorMessage} from "./scenes/Scene4ErrorMessage";
import {Scene5Skeleton} from "./scenes/Scene5Skeleton";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  entrypoint: Scene2EntryPoint,
  otherpackages: Scene3OtherPackages,
  errormessage: Scene4ErrorMessage,
  skeleton: Scene5Skeleton,
