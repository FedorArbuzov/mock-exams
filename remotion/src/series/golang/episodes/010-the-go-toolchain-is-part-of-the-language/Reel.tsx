...
import {Scene2Workflow} from "./scenes/Scene2Workflow";
import {Scene3Integration} from "./scenes/Scene3Integration";
import {Scene4LearnEarly} from "./scenes/Scene4LearnEarly";
import {Scene5StarterTrio} from "./scenes/Scene5StarterTrio";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  workflow: Scene2Workflow,
  integration: Scene3Integration,
  learnearly: Scene4LearnEarly,
  startertrio: Scene5StarterTrio,
