...
import {Scene2Guarantee} from "./scenes/Scene2Guarantee";
import {Scene3Safe} from "./scenes/Scene3Safe";
import {Scene4DesignWith} from "./scenes/Scene4DesignWith";
...
const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  ...
  guarantee: Scene2Guarantee,
  safe: Scene3Safe,
  designwith: Scene4DesignWith,
  review: Scene5Review,
