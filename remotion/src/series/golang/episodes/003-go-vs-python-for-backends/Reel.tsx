...
import {Scene2Tradeoff} from "./scenes/Scene2Tradeoff";
import {Scene3CompileTime} from "./scenes/Scene3CompileTime";
import {Scene4Coexist} from "./scenes/Scene4Coexist";
import {Scene5RuleOfThumb} from "./scenes/Scene5RuleOfThumb";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  tradeoff: Scene2Tradeoff,
  compiletime: Scene3CompileTime,
  coexist: Scene4Coexist,
  ruleofthumb: Scene5RuleOfThumb,
