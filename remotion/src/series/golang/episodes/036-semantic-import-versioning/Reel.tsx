...
import {Scene2Rule} from "./scenes/Scene2Rule";
import {Scene3Coexist} from "./scenes/Scene3Coexist";
import {Scene4NotDecoration} from "./scenes/Scene4NotDecoration";
import {Scene5PublishRule} from "./scenes/Scene5PublishRule";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  rule: Scene2Rule,
  coexist: Scene3Coexist,
  notdecoration: Scene4NotDecoration,
  publishrule: Scene5PublishRule,
