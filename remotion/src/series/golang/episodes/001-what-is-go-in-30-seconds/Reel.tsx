...
import {Scene2Compiled} from "./scenes/Scene2Compiled";
import {Scene3Teams} from "./scenes/Scene3Teams";
import {Scene4Mental} from "./scenes/Scene4Mental";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  compiled: Scene2Compiled,
  teams: Scene3Teams,
  mental: Scene4Mental,
