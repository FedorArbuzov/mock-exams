...
import {Scene2WhatItCatches} from "./scenes/Scene2WhatItCatches";
import {Scene3NotLinter} from "./scenes/Scene3NotLinter";
import {Scene4Pairing} from "./scenes/Scene4Pairing";
import {Scene5CIMin} from "./scenes/Scene5CIMin";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  whatitcatches: Scene2WhatItCatches,
  notlinter: Scene3NotLinter,
  pairing: Scene4Pairing,
  cimin: Scene5CIMin,
