...
import {Scene2Definitions} from "./scenes/Scene2Definitions";
import {Scene3Containment} from "./scenes/Scene3Containment";
import {Scene4MixingBugs} from "./scenes/Scene4MixingBugs";
import {Scene5MemoryHook} from "./scenes/Scene5MemoryHook";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  definitions: Scene2Definitions,
  containment: Scene3Containment,
  mixingbugs: Scene4MixingBugs,
  memoryhook: Scene5MemoryHook,
