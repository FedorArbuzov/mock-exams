...
import {Scene2Bothwork} from "./scenes/Scene2Bothwork";
import {Scene3Literal} from "./scenes/Scene3Literal";
import {Scene4Whennew} from "./scenes/Scene4Whennew";
...
const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  ...
  bothwork: Scene2Bothwork,
  literal: Scene3Literal,
  whennew: Scene4Whennew,
  style: Scene5Style,
