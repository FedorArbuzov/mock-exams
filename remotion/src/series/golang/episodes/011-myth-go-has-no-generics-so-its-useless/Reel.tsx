...
import {Scene2Unlocked} from "./scenes/Scene2Unlocked";
import {Scene3SmallCodebase} from "./scenes/Scene3SmallCodebase";
import {Scene4InterviewTrap} from "./scenes/Scene4InterviewTrap";
...
const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  ...
  unlocked: Scene2Unlocked,
  smallcodebase: Scene3SmallCodebase,
  interviewtrap: Scene4InterviewTrap,
  rule: Scene5Rule,
