...
import {Scene2BadFits1} from "./scenes/Scene2BadFits1";
import {Scene3BadFits2} from "./scenes/Scene3BadFits2";
import {Scene4Tradeoff} from "./scenes/Scene4Tradeoff";
import {Scene5SanityCheck} from "./scenes/Scene5SanityCheck";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  badfits1: Scene2BadFits1,
  badfits2: Scene3BadFits2,
  tradeoff: Scene4Tradeoff,
  sanitycheck: Scene5SanityCheck,
