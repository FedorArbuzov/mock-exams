...
import {Scene3Authoritative} from "./scenes/Scene3Authoritative";
import {Scene4OwnPackages} from "./scenes/Scene4OwnPackages";
...
const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  ...
  usage: Scene2Usage,
  authoritative: Scene3Authoritative,
  ownpackages: Scene4OwnPackages,
  habit: Scene5Habit,
