...
import {Scene2Companies} from "./scenes/Scene2Companies";
import {Scene3FastCI} from "./scenes/Scene3FastCI";
import {Scene4Interview} from "./scenes/Scene4Interview";
import {Scene5Takeaway} from "./scenes/Scene5Takeaway";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  companies: Scene2Companies,
  fastci: Scene3FastCI,
  interview: Scene4Interview,
  takeaway: Scene5Takeaway,
