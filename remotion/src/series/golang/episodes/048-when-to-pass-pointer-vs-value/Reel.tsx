...
import {Scene2Heuristic} from "./scenes/Scene2Heuristic";
import {Scene3Methods} from "./scenes/Scene3Methods";
import {Scene4Overuse} from "./scenes/Scene4Overuse";
...
const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  ...
  heuristic: Scene2Heuristic,
  methods: Scene3Methods,
  overuse: Scene4Overuse,
  rule: Scene5Rule,
