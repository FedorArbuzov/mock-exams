...
import {Scene2Source} from "./scenes/Scene2Source";
import {Scene3VersionCheck} from "./scenes/Scene3VersionCheck";
import {Scene4OnePath} from "./scenes/Scene4OnePath";
import {Scene5FirstHour} from "./scenes/Scene5FirstHour";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  source: Scene2Source,
  versioncheck: Scene3VersionCheck,
  onepath: Scene4OnePath,
  firsthour: Scene5FirstHour,
