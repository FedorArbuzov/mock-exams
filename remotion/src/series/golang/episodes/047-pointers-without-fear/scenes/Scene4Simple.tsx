...
export const Scene4Simple: React.FC<Props> = ({text, durationInFrames}) => {
      ...
      >
        <Panel width={960} height={720}>
          ...
          >
            ...
            <div style={{color: COLORS.red, fontFamily: FONTS.sans, fontSize: 34, fontWeight: 700, opacity: crossIn}}>
              no pointer math
            </div>
          </div>
          ...
          >
            <Share2 size={64} color={COLORS.cyan} strokeWidth={1.6} />
