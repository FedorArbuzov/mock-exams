...
import {Scene3Deploys} from "./scenes/Scene3Deploys";
import {Scene4CrossBuild} from "./scenes/Scene4CrossBuild";
import {Scene5Mental} from "./scenes/Scene5Mental";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  build: Scene2Build,
  deploys: Scene3Deploys,
  crossbuild: Scene4CrossBuild,
  mental: Scene5Mental,
