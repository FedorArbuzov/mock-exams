...
import {Scene2SweetSpots} from "./scenes/Scene2SweetSpots";
import {Scene3PlatformTools} from "./scenes/Scene3PlatformTools";
import {Scene4LessCommon} from "./scenes/Scene4LessCommon";
import {Scene5QuickFilter} from "./scenes/Scene5QuickFilter";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  sweetspots: Scene2SweetSpots,
  platformtools: Scene3PlatformTools,
  lesscommon: Scene4LessCommon,
  quickfilter: Scene5QuickFilter,
