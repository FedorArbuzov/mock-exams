...
import {Scene2Checks} from "./scenes/Scene2Checks";
import {Scene3AlsoCheck} from "./scenes/Scene3AlsoCheck";
import {Scene4Boring} from "./scenes/Scene4Boring";
import {Scene5HealthCheck} from "./scenes/Scene5HealthCheck";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  checks: Scene2Checks,
  alsocheck: Scene3AlsoCheck,
  boring: Scene4Boring,
  healthcheck: Scene5HealthCheck,
