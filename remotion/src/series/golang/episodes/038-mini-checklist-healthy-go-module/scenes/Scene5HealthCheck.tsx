...
import {BookOpen, Hammer, TestTube, Wand2} from "lucide-react";
...
const ITEMS = [
  ...
  {label: "tidy", Icon: Wand2},
  {label: "test", Icon: TestTube},
  {label: "document", Icon: BookOpen},
];

export const Scene5HealthCheck: React.FC<Props> = ({text, durationInFrames}) => {
