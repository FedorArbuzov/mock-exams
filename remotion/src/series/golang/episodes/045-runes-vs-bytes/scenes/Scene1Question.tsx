...
import {Binary, LetterText, Type} from "lucide-react";
...
const ICONS = [
  {id: "type", Icon: Type, delay: 0},
  {id: "binary", Icon: Binary, delay: 6},
  {id: "letter", Icon: LetterText, delay: 12},
] as const;
        ...
        <Panel width={780} height={760}>
          ...
          >
            {ICONS.map(({id, Icon, delay}) => (
              <div
                key={id}
                style={fadeSlideUpWith("translateY(0)", frame, delay, 18)}
              >
                <Icon size={96} color={COLORS.cyan} strokeWidth={1.5} />
              </div>
            ))}
          </div>
