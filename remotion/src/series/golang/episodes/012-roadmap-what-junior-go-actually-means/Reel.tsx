...
import {Scene2CoreSkills} from "./scenes/Scene2CoreSkills";
import {Scene3Vocabulary} from "./scenes/Scene3Vocabulary";
import {Scene4CleanRepo} from "./scenes/Scene4CleanRepo";
import {Scene5HiringBar} from "./scenes/Scene5HiringBar";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  coreskills: Scene2CoreSkills,
  vocabulary: Scene3Vocabulary,
  cleanrepo: Scene4CleanRepo,
  hiringbar: Scene5HiringBar,
