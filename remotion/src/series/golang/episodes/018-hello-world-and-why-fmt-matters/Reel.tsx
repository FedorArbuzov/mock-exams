...
import {Scene2FmtBasics} from "./scenes/Scene2FmtBasics";
import {Scene3WhyItMatters} from "./scenes/Scene3WhyItMatters";
import {Scene4HelloWorldProof} from "./scenes/Scene4HelloWorldProof";
import {Scene5VerbsExample} from "./scenes/Scene5VerbsExample";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  fmtbasics: Scene2FmtBasics,
  whyitmatters: Scene3WhyItMatters,
  helloworldproof: Scene4HelloWorldProof,
  verbsexample: Scene5VerbsExample,
