...
import {Scene2Decision} from "./scenes/Scene2Decision";
import {Scene3Savings} from "./scenes/Scene3Savings";
import {Scene4EditorIntegration} from "./scenes/Scene4EditorIntegration";
...
const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  ...
  decision: Scene2Decision,
  savings: Scene3Savings,
  editorintegration: Scene4EditorIntegration,
  rule: Scene5Rule,
