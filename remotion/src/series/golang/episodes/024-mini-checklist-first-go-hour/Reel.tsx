...
import {Scene2FourThings} from "./scenes/Scene2FourThings";
import {Scene3CoreLoop} from "./scenes/Scene3CoreLoop";
import {Scene4DontOverdo} from "./scenes/Scene4DontOverdo";
import {Scene5Checklist} from "./scenes/Scene5Checklist";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  fourthings: Scene2FourThings,
  coreloop: Scene3CoreLoop,
  dontoverdo: Scene4DontOverdo,
  checklist: Scene5Checklist,
