...
import {Scene2Schedule} from "./scenes/Scene2Schedule";
import {Scene3Multi} from "./scenes/Scene3Multi";
import {Scene4Rule} from "./scenes/Scene4Rule";
import {Scene5Diagnose} from "./scenes/Scene5Diagnose";
import {Scene6CTA} from "./scenes/Scene6CTA";

const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  question: Scene1Question,
  schedule: Scene2Schedule,
  multicontainer: Scene3Multi,
  rule: Scene4Rule,
  diagnose: Scene5Diagnose,
  cta: Scene6CTA,
};
