...
import {Scene2Manage} from "./scenes/Scene2Manage";
import {Scene3DesiredState} from "./scenes/Scene3DesiredState";
import {Scene4Controller} from "./scenes/Scene4Controller";
import {Scene5Crash} from "./scenes/Scene5Crash";
...
const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  ...
  manage: Scene2Manage,
  desired: Scene3DesiredState,
  controller: Scene4Controller,
  crash: Scene5Crash,
  scale: Scene6Scale,
  cta: Scene7CTA,
};
