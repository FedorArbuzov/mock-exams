...
const LINES = ["Deployment selector", "Service selector", "change = new owner"] as const;

export const Scene3Pitfall: React.FC<Props> = ({text, durationInFrames}) => {
