...
import {Scene2Declare} from "./scenes/Scene2Declare";
import {Scene3Idempotent} from "./scenes/Scene3Idempotent";
import {Scene4Pitfall} from "./scenes/Scene4Pitfall";
...
const SCENE_MAP: Record<string, React.FC<{text: string; durationInFrames: number}>> = {
  ...
  declare: Scene2Declare,
  idempotent: Scene3Idempotent,
  pitfall: Scene4Pitfall,
  rule: Scene5Rule,
