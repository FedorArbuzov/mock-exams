...
/** Shared final-scene template: zoom-out + drifting particles + CTA card. Reused by every episode. */
export const CTAScene: React.FC<CTASceneProps> = ({text, durationInFrames, headline}) => {
