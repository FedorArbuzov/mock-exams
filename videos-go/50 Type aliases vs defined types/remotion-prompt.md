...
Scenes: question → defined type distinct → alias same type → domain types → rule checklist → CTA (Master Go Faster / Theory • Hands-on Labs • Interview Questions / Link in Bio / exallenge.tech).

Export: 1080×1920 @ 30 FPS. Composition: `golang-050-type-aliases-vs-defined-types`.
